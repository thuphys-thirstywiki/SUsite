# <img class="page-icon" src="/icons/activities.svg" alt="" />活动

每项活动均以活动名称为一级目录，下面固定收纳三类文档：**活动介绍**、**开展指南**、**流程总结**。需要复用的表单和外链统一放入素材库，并在这里链接。
...
```text
wiki/activities/<活动名称>/
  index.md              # 活动介绍与总入口
  runbook.md            # 开展指南
  retrospective.md      # 流程总结
```
